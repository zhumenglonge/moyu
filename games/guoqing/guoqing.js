  ...
  var ROUTES = [
    {
      ...
      fields: {
        duration: "3 天 2 晚（武昌 1 晚 + 汉口 1 晚，按区域住少走回头路）",
        getThere: "长沙南→武汉站高铁约 1.5h（班次密集随到随走）；武汉站→武昌核心区地铁 4 号线约 20 分钟；汉口住宿建议换 2 号线沿线",
        budget: "人均 ¥450~700：高铁往返 ~260 + 过早/正餐 80~120/天 + 景点（东湖免费 + 省博免费 + 轮渡 1.5）+ 地铁公交 20/天 + 住宿 2 晚 200~350",
        itinerary: [
          { day: "Day1", plan: "早上到武汉，放行李直奔粮道街/水塔美食街过早（热干面+豆皮+糊汤粉一套连击），上午湖北省博物馆（曾侯乙编钟+越王勾践剑，免费需预约），下午东湖绿道骑行或听涛景区散步，傍晚楚河汉街逛吃，宿武昌" },
          { day: "Day2", plan: "清早去昙华林人少时拍照，上午从阅马场一带远看黄鹤楼外观+拍照（不上楼），步行长江大桥桥头堡→轮渡过江到汉口（1.5 元看两岸风景，比打车强），下午江汉路步行街→黎黄陂路老租界咖啡，晚上汉口江滩看灯光秀，宿汉口" },
          { day: "Day3", plan: "早上去万松园/六渡桥吃最后一顿过早（三鲜豆皮认准老通城），上午古德寺或武汉美术馆消食，中午排骨藕汤收尾，下午高铁回长沙" }
        ],
        pitfalls: "户部巷国庆全是外地游客，本地人从不去——过早认准粮道街、水塔、万松园；武汉站和汉口站相距远，买回程票看清车站别跑错；黄鹤楼 70 块门票不值得，阅马场或长江大桥上外观更美还免费；10 月正热且干，防晒+补水别大意；湖北省博物馆国庆预约秒没，提前 3 天 0 点蹲公众号放票",
        food: "热干面（蔡林记连锁即可，街边小摊更香）、三鲜豆皮、糊汤粉配油条、排骨藕汤（靓王汤煲）、周黑鸭/精武鸭脖、面窝、蛋酒、梁子湖大闸蟹（10 月正肥）"
      }
    },
    {
      id: "hengshan",
