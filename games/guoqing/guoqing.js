  ...
  var ROUTES = [
    {
      ...
      fields: {
        ...
        itinerary: [
          { day: "Day1", plan: "清早 6 点前出发避首日车流，中午前后到武汉直接停粮道街/水塔附近吃午过（热干面+豆皮+糊汤粉一套连击），下午湖北省博物馆（曾侯乙编钟+越王勾践剑，免费需预约），傍晚东湖绿道散步或听涛片区发呆，晚上楚河汉街逛吃——正餐认准湖锦酒楼：排骨藕汤+清蒸武昌鱼，宿武昌" },
          { day: "Day2", plan: "上午车停黄鹤楼停车场，阅马场红墙远观拍照（不上楼）→步行桥头堡看长江大桥，开车过桥到汉口（桥面客车免费，江景一遍带走），黎黄陂路老租界+江汉路消食，午饭走到中山大道老蒸菜馆：粉蒸肉+蒸珍珠圆子+排骨藕汤，15 点前出发返长，避开尾日车流晚饭前到家" }
        ],
        ...
        food: "过早小吃：热干面（蔡林记连锁即可，街边小摊更香）、三鲜豆皮、糊汤粉配油条、面窝、蛋酒；正餐三板斧：蒸菜（粉蒸肉/蒸珍珠圆子，汉口中山大道老字号）、煨汤（洪湖排骨藕汤认靓王汤煲/湖锦酒楼）、江湖鱼鲜（清蒸武昌鱼、干烧鱼）；夜宵加场：三鲜豆皮切块当夜宵、油焖大虾（10 月是尾季看运气）；伴手带：洪湖/蔡甸藕粉（冲糊当夜宵）、蔡林记方便热干面礼盒、汪玉霞白糖糕/京果（三百年老号糕点）"
      }
    },
    {
      id: "hengshan",
